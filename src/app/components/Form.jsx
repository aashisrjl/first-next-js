  ...
  return (
    <>
     <div className="mx-14 mt-10 border-2 border-blue-400 rounded-lg">
        <div className="mt-10 text-center font-bold">{header} Recipe</div>
        <div className="mt-3 text-center text-4xl font-bold">{header} a Recipe</div>
        <div className="p-8">
          ...
          <div className="text-center">
            <a className="cursor-pointer rounded-lg bg-blue-700 px-8 py-5 text-sm font-semibold text-white">{header} Now</a>
          </div>
        </div>
      </div>
